...
filtered_data_survey <-  filtered_data_survey %>% select(-race_ethnicity, -vote_intention, -registration, -foreign_born)
...
# working directory
write_csv(filtered_data_survey,'./../../outputs/survey_data.csv')
